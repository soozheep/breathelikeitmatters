const SITE_URL = 'https://breathelikeitmatters.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Breathe Like It Matters — Sonic Remedy | Soozhee',
        text: 'Sing a song like your heart depends on it. Breathe each breath like your whole life\'s on it. — Breathe Like It Matters by Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
